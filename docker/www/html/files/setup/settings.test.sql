...
-- Set Host
--
UPDATE `sales_channel_domain` SET `url` = 'http://test.m-medientechnik.de/' WHERE `id` = 0xcdcfbb5ea2dd4891ae7a782c678c9aaa;
UPDATE `sales_channel_domain` SET `url` = 'https://test.m-medientechnik.de/' WHERE `id` = 0x47c8d1b3ba684d6ba847ab87d90ca3df;
