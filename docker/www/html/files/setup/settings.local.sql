...
-- Set Host
--
UPDATE `sales_channel_domain` SET `url` = 'http://localhost' WHERE `id` = 0xcdcfbb5ea2dd4891ae7a782c678c9aaa;
UPDATE `sales_channel_domain` SET `url` = 'https://localhost' WHERE `id` = 0x47c8d1b3ba684d6ba847ab87d90ca3df;
